        ...
        <>
            ...
            <View style={tables_ttd.table}>
                ...
                <View style={tables_ttd.containerRow}>
                    ...
                    <View style={tables_ttd.param}>
                        <Text style={tables_ttd.guru}>{props.wali.nama}</Text>
                        <Text style={tables_ttd.nip}>
                            NIP . {props.wali.nip}
                        </Text>
                    </View>
                </View>
            ...
            <View style={tables_ttd.table}>
                <View style={tables_ttd.containerRowFull}>
                    ...
                    <View style={tables_ttd.param}>
                        <Text style={tables_ttd.guru}>Herry Sutanto, S.Pd</Text>
                        <Text style={tables_ttd.nip}>
                            NIP . 11991331014801022003
                        </Text>
                    </View>
                </View>
            </View>
